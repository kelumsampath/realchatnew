...
//    
    ...
    socket.on('group', function(data) {
        ...
        if(data.split("#*@")[1]!=$scope.user){
            div.innerHTML='<div class="direct-chat-msg right">\
                            ...
                            <img class="direct-chat-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTD9JMvs7bUk9FG32phF5w5iC6CR-eT9mU-nd61JDASUNXt3X-" alt="image">\
    ...
    $scope.group_message= function(message){
        ...
        div.innerHTML='<div class="direct-chat-msg"> \
                        ...
                        <img class="direct-chat-img" src="https://www.create.ac.uk/wp-content/uploads/2013/08/no_picture.png"\ alt="message user image">\
                        <div class="direct-chat-text">'
                        +message+
                        '</div>\
                        </div>';
...
//        }
        ...
        div.innerHTML='<div class="popup-box popup-box-on chat-popup" id="'+chat_friend+'01">\
                        ...
                        <div class="popup-head-left pull-left"><img src="https://i1.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1"  alt="pic">'+chat_friend+'</div>\
